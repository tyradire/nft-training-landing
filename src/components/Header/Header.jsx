...
export const Header = () => {
  ...
  return (
    <header className='header'>
      <span><LogoIcon mobile={!mobileView} /></span>
      <nav className='header__navigate'>
        {
          !mobileView ?
          <ul>
            <li><a href='#'>Главная</a></li>
            <li><a href='#'>Что даст обучение</a></li>
          </ul> :
          <>
            <div className={!menuOpened ? 'header__cover' : 'header__cover header__cover_opened'}>
              <div className={!menuOpened ? 'header__mobile-menu' : 'header__mobile-menu header__mobile-menu_opened'}>
                <div className='mobile-menu__top'>
                  <LogoIcon mobile={!mobileView} />
                  <button className='mobile-menu__close-btn' onClick={openMenu}>
            ...
            <div className='header__navigate-mobile'>
              <input className='header__checkbox' type='checkbox' id='checkbox-1' onChange={openMenu}/>
              <label className='header__label' htmlFor='checkbox-1'>
                <div></div>
                <div></div>
              </label>
            </div>
